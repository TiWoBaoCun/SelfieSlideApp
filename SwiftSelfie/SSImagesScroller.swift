...
class SSImagesScroller: UICollectionViewController, UIScrollViewDelegate, SSSessionDelegate {
    ...
    override func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        var (url, image) = arrImageTuple[indexPath.row]
    ...
    override func scrollViewDidScroll( scrollView: UIScrollView ){
        ...
        if collectionView.contentOffset.y >= self.collectionView.contentSize.height - (self.collectionView.frame.size.height * 3) && !isGettingImages  {
